...
//  $_SESSION["parking_section_js"] = json_encode($_POST['Parking_Section2']);
  ...
  $_SESSION["street_level"] = $street_level;
  ...
  $_SESSION["utility"] = $utility;
  $_SESSION["building"] = $building;
  //skip dates
  $_SESSION["room_furnished"] = $room_furnished;
  $_SESSION["date_negotiable"] = $date_negotiable;
  //Lease Type
  $_SESSION["leasetype"] = $leasetype;
  $_SESSION["lease_type_value"] = $lease_type_value;

  // sq.fts and intersection
  $_SESSION["fts"] = $fts;
  $_SESSION["inter"] = $inter;
  //last four field
  $_SESSION["additional_details"] = $additional_details;

  $_SESSION["im_looking_for"] = $im_looking_for;
  $_SESSION["maximum_number"] = $maximum_number;
  //*
  ...
  $_SESSION["security_amount"] = $security_amount ;
  $_SESSION["brokerfee_amount"] = $brokerfee_amount; 

  /// 2)HRES Apartment Source Pays For
  $_SESSION['hres_apartment'] = $hres_apartment;
  $_SESSION['No_Utilities'] = $no_utilities = $_POST['No_Utilities'];

  //  3)rental_features
  $_SESSION["rental_features"] = $rental_features;

  //  4)community_features2
  $_SESSION["other_features"] = $other_features;
  //  5)Parking_Section
  $_SESSION["parking_section"] = $parking_section;
...
border=0>
                    ...
                    <TR>
                      ...
                      <TD colSpan=4 height=29>
                        ...
                        id=propertyName maxLength=100  name=propertyName value="<?=$_SESSION["property_name"];
echo $property_name;
?>"> 
                      ...
                      <TD colSpan=4 height=29>
                        ...
                        <TBODY>
                          <TR>
                            ...
                            value=City1
                             <?=$_SESSION["city"] == "City1" || $city == "City1" ? "checked" : "";?> name=city> </TD>
                            <TD width=90>City1&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City2 <?=$_SESSION["city"] == "City2" || $city == "City2" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City2&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City3 <?=$_SESSION["city"] == "City3" || $city == "City3" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City3&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City4 <?=$_SESSION["city"] == "City4" || $city == "City4" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City4&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City5 <?=$_SESSION["city"] == "City5" || $city == "City5" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City5&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                          <TR>
                            <TD width=10><INPUT class=radio type=radio
                              value=City6 <?=$_SESSION["city"] == "City6" || $city == "City6" ? "checked" : "";?> name=city> </TD>
                            <TD width=90>City6&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City7 <?=$_SESSION["city"] == "City7" || $city == "City7" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City7&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                            <TD width=10><INPUT class=radio type=radio
                              value=City8 <?=$_SESSION["city"] == "City8" || $city == "City8" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City8&nbsp;&nbsp;&nbsp;&nbsp; </TD>


                            <TD width=10><INPUT class=radio type=radio
                              value=City9 <?=$_SESSION["city"] == "City9" || $city == "City9" ? "checked" : "";?>  name=city> </TD>
                            <TD width=90>City9&nbsp;&nbsp;&nbsp;&nbsp; </TD>


                            <TD width=10 class="d-flex flex-column"><INPUT class=radio type=radio
                            value=City10 <?=$_SESSION["city"] == "City10" || $city == "City10" ? "checked" : "";?>  name=city>
                    ...
                    <TR>
                      ...
                      name=state> <OPTION value="" selected>Select
                          ...
                          <OPTION
                           value=Alaska
                           <?=$_SESSION["state"] == "Alaska" || $state == "Alaska" ? "selected" : "";
?>>Alaska</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Arizona" || $state == "Arizona" ? "selected" : "";
?>
                          value=Arizona>Arizona</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Arkansas" || $state == "Arkansas" ? "selected" : "";
?>
                          value=Arkansas>Arkansas</OPTION>
                          <OPTION <?=$_SESSION["state"] == "California" || $state == "California" ? "selected" : "";
?>
                           value=California>California</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Colorado" || $state == "Colorado" ? "selected" : "";
?>
                          value=Colorado>Colorado</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Connecticut" || $state == "Connecticut" ? "selected" : "";
?>
                          value=Connecticut>Connecticut</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Delaware" || $state == "Delaware" ? "selected" : "";
?>
                          value=Delaware>Delaware</OPTION>
                          <OPTION <?=$_SESSION["state"] == "District of Columbia" || $state == "District of Columbia" ? "selected" : "";
?>
                          value="District of Columbia">District of Columbia</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Florida" || $state == "Florida" ? "selected" : "";
?>
                          value=Florida>Florida</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Georgia" || $state == "Georgia" ? "selected" : "";
?>
                          value=Georgia>Georgia</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Guam" || $state == "Guam" ? "selected" : "";
?>
                          value=Guam>Guam</OPTION>
                           <OPTION <?=$_SESSION["state"] == "Hawaii" || $state == "Hawaii" ? "selected" : "";
?>
                          value=Hawaii>Hawaii</OPTION>
                           <OPTION <?=$_SESSION["state"] == "Idaho" || $state == "Idaho" ? "selected" : "";
?>
                          value=Idaho>Idaho</OPTION>
                          <OPTION <?=$_SESSION["state"] == "Illinois" || $state == "Illinois" ? "selected" : "";
?>
                          value=Illinois>Illinois</OPTION>
                          <OPTION value=Indiana <?=$_SESSION["state"] || $state == "Indiana" ? "selected" : "";?> >Indiana</OPTION>
                          <OPTION
                          value=Iowa <?=$_SESSION["state"] == "Iowa" || $state == "Iowa" ? "selected" : "";?>>Iowa</OPTION>
                          <OPTION
                          value=Kansas <?=$_SESSION["state"] == "Kansas" || $state == "Kansas" ? "selected" : "";?>>Kansas</OPTION>
                         <OPTION
                          value=Kentucky <?=$_SESSION["state"] == "Kentucky" || $state == "Kentucky" ? "selected" : "";?> >Kentucky</OPTION>
                         <OPTION
                          value=Louisiana <?=$_SESSION["state"] == "Louisiana" || $state == "Louisiana" ? "selected" : "";?> >Louisiana</OPTION>
                         <OPTION
                          value=Maine <?=$_SESSION["state"] == "Maine" || $state == "Maine" ? "selected" : "";?> >Maine</OPTION>
                         <OPTION
                          value=Maryland <?=$_SESSION["state"] == "Maryland" || $state == "Maryland" ? "selected" : "";?> >Maryland</OPTION>
                         <OPTION
                          value=Massachusetts <?=$_SESSION["state"] == "Massachusetts" || $state == "Massachusetts" ? "selected" : "";?> >Massachusetts</OPTION>
                         <OPTION
                          value=Michigan <?=$_SESSION["state"] == "Michigan" || $state == "Michigan" ? "selected" : "";?> >Michigan</OPTION>
                         <OPTION
                          value=Minnesota <?=$_SESSION["state"] == "Minnesota" || $state == "Minnesota" ? "selected" : "";?> >Minnesota</OPTION>
                        <OPTION
                          value=Mississippi <?=$_SESSION["state"] == "Mississippi" || $state == "Mississippi" ? "selected" : "";?> >Mississippi</OPTION></SELECT>
                    <!-- /////// -->
                    ...
                    <?= $state_error ? '<p style="color:red; font-size: 10px;">' . $state_error . '</p>' : ''; ?>
                      ...
                      <TD colSpan=2 height=29><INPUT class=inputtext id=zip
                        maxLength=100 name=zip value="<?=$_SESSION["zip"];
echo $zip;
?>">
 ...
 >
                      ...
                      name=Bedrooms>
                        <OPTION value="" selected>Please Select</OPTION>
                          <OPTION
                          <?=$_SESSION["bed"] || $bed == '1' ? "selected" : "";?> value=1>1</OPTION>
                           <OPTION
                           <?=$_SESSION["bed"] || $bed == '2' ? "selected" : "";?> value=2>2</OPTION>
                          <OPTION
                          <?=$_SESSION["bed"] || $bed == '3' ? "selected" : "";?>
                          value=3>3</OPTION> <OPTION
                          <?=$_SESSION["bed"] || $bed == '4' ? "selected" : "";?>
...
></TD>
                      ...
                      name=Bathrooms>
                        <OPTION value="" selected>Please Select</OPTION>
                          <OPTION
                          <?=$_SESSION["bath"] || $bath == '2' ? "selected" : "";?> value=2>2</OPTION> <OPTION
                          <?=$_SESSION["bath"] || $bath == '3' ? "selected" : "";?> value=3>3</OPTION>
                          <OPTION
                          <?=$_SESSION["bath"] || $bath == '4' ? "selected" : "";?>value=4>4</OPTION> <OPTION

                          <?=$_SESSION["bath"] || $bath == '5' ? "selected" : "";?>   value=5>5</OPTION> </SELECT>
...
?>"
                    ...
                    <TR>
                      ...
                      <TD width=193 height=29>
                        ...
                        name=AvailMonth>
                          <OPTION  value="" selected>Please Select</OPTION>
                        <OPTION <?php if ( $_SESSION["month"]=='1') { echo "selected";}?>  value=1>Jan</OPTION>
                          <OPTION <?php if ( $_SESSION["month"]=='2') { echo "selected";}?> value=2>Feb</OPTION> <OPTION
                          <?php if ( $_SESSION["month"]=='3') { echo "selected";}?> value=3>Mar</OPTION> 
                          <OPTION <?php if ( $_SESSION["month"]=='4') { echo "selected";}?> value=4>Apr</OPTION>
                          <OPTION <?php if ( $_SESSION["month"]=='5') { echo "selected";}?> value=5>May</OPTION> <OPTION
                          <?php if ( $_SESSION["month"]=='6') { echo "selected";}?> value=6>Jun</OPTION> <OPTION 
                          <?php if ( $_SESSION["month"]=='7') { echo "selected";}?> value=7>Jul</OPTION>
                          <OPTION <?php if ( $_SESSION["month"]=='8') { echo "selected";}?> value=8>Aug</OPTION> <OPTION
                          <?php if ( $_SESSION["month"]=='9') { echo "selected";}?> value=9>Sep</OPTION>
                           <OPTION <?php if ( $_SESSION["month"]=='10') { echo "selected";}?> value=10>Oct</OPTION>
                          <OPTION <?php if ( $_SESSION["month"]=='11') { echo "selected";}?> value=11>Nov</OPTION> <OPTION
                          <?php if ( $_SESSION["month"]=='12') { echo "selected";}?> value=12>Dec</OPTION></SELECT> <SELECT class=inputtext
                        name=AvailDay>
                          <OPTION value="">Please Select</OPTION>
                        <OPTION <?php if ( $_SESSION["dated"]=='1') { echo "selected";}?> value=1>1</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='2') { echo "selected";}?> value=2>2</OPTION> 
                          <OPTION <?php if ( $_SESSION["dated"]=='3') { echo "selected";}?> value=3>3</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='4') { echo "selected";}?> value=4>4</OPTION>
                           <OPTION  <?php if ( $_SESSION["dated"]=='5') { echo "selected";}?> value=5>5</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='6') { echo "selected";}?> value=6>6</OPTION> 
                          <OPTION  <?php if ( $_SESSION["dated"]=='7') { echo "selected";}?> value=7>7</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='8') { echo "selected";}?> value=8>8</OPTION> 
                          <OPTION  <?php if ( $_SESSION["dated"]=='9') { echo "selected";}?> value=9>9</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='10') { echo "selected";}?> value=10>10</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='11') { echo "selected";}?> value=11>11</OPTION> <OPTION 
                          <?php if ( $_SESSION["dated"]=='12') { echo "selected";}?> value=12>12</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='13') { echo "selected";}?> value=13>13</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='14') { echo "selected";}?> value=14>14</OPTION> 
                          <OPTION <?php if ( $_SESSION["dated"]=='15') { echo "selected";}?> value=15>15</OPTION>
                          <OPTION 
                          <?php if ( $_SESSION["dated"]=='16') { echo "selected";}?> value=16>16</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='17') { echo "selected";}?> value=17>17</OPTION> 
                          <OPTION <?php if ( $_SESSION["dated"]=='18') { echo "selected";}?> value=18>18</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='19') { echo "selected";}?> value=19>19</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='20') { echo "selected";}?> value=20>20</OPTION> <OPTION 
                          <?php if ( $_SESSION["dated"]=='21') { echo "selected";}?> value=21>21</OPTION>
                          <OPTION <?php if ( $_SESSION["dated"]=='22') { echo "selected";}?> value=22>22</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='23') { echo "selected";}?> value=23>23</OPTION> <OPTION 
                          <?php if ( $_SESSION["dated"]=='24') { echo "selected";}?> value=24>24</OPTION>
                          <?php if ( $_SESSION["dated"]=='25') { echo "selected";}?> <OPTION value=25>25</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='26') { echo "selected";}?> value=26>26</OPTION> <OPTION 
                          <?php if ( $_SESSION["dated"]=='27') { echo "selected";}?> value=27>27</OPTION>
                          <OPTION
                          <?php if ( $_SESSION["dated"]=='28') { echo "selected";}?> value=28>28</OPTION> <OPTION
                          <?php if ( $_SESSION["dated"]=='29') { echo "selected";}?> value=29>29</OPTION> <OPTION 
                          <?php if ( $_SESSION["dated"]=='30') { echo "selected";}?> value=30>30</OPTION>
                        ...
                        <SELECT class=inputtext onchange=checkDays();  name=AvailYear>
                          ...
                          <OPTION <?php if ( $_SESSION["year"]=='2012') { echo "selected";}?> value=2012>2012</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2013') { echo "selected";}?> value=2013>2013</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2014') { echo "selected";}?> value=2014>2014</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2015') { echo "selected";}?> value=2015>2015</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2016') { echo "selected";}?> value=2016>2016</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2017') { echo "selected";}?> value=2017>2017</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2018') { echo "selected";}?> value=2018>2018</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2019') { echo "selected";}?> value=2019>2019</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2020') { echo "selected";}?> value=2020>2020</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2021') { echo "selected";}?> value=2021>2021</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2022') { echo "selected";}?> value=2022>2022</OPTION>
                          <OPTION <?php if ( $_SESSION["year"]=='2023') { echo "selected";}?> value=2023>2023</OPTION>
                        </SELECT>
                        <SCRIPT>
							currdate();
...
:&nbsp;</STRONG></TD>
                      ...
                      rows=5 wrap=VIRTUAL cols=60><?= $_SESSION["additional_details"]; echo $additional_details; ?></TEXTAREA>
                        <BR>
                    ...
                    <TR>
                      ...
                      <TD colSpan=3 height=71><TEXTAREA class=inputtext name=LookingFor rows=5 wrap=VIRTUAL cols=60><?php echo $_SESSION["im_looking_for"]; echo $im_looking_for; ?></TEXTAREA>
                         <BR>
                        <DIV align=right><SPAN
                        class=smallbluetext><B>characters:</B></SPAN>
                      ...
                      <TD colSpan=4 height=29>
                        <TABLE cellSpacing=0 cellPadding=0 width=490 border=0>
                          ...
                          <TR>
                            ...
                            v  value="<?=  $_SESSION["maximum_number"]; echo $maximum_number; ?>">
                            ...
                            <TD width=110>
                              ...
                              <?php if ($_SESSION["preference"] == 'Male') {echo "checked";}?> 
                              ></TD>
                            <TD width=51>Male(s)</TD>
                            <TD width=20><INPUT class=radio id=Preference
                              type=checkbox value=Female name=Preference
                              <?php if ($_SESSION["preference"] == 'Female') {echo "checked";}?> 
                              ></TD>
