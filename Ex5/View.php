...
if ($_SESSION['Semail']) {
    ...
    <br>
        ...
        if(!empty($_SESSION['room_furnished'])){  
    ...
    foreach ($options  as $key => $option){
       ...
       $options=($_SESSION['hres_apartment']);
       if ($options) {
        # code...
       ...
       echo "Option " .($key+1). "=<strong> " .$option. "</strong>";
        ...
        if ($_SESSION['No_Utilities']) {
            echo "Option 1 = <strong>" . $_SESSION['No_Utilities'] . "</strong><br>";
        }
        echo"<br>";
        echo"<br>";
    }
    ...
    $community_features=($_SESSION["other_features"]);
    ...
    // die;
        ...
        foreach ($parking_section as $key => $p_r) {
            ...
            if ($p_r == "Garage") {
                ...
                echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Garage_amount  = <strong> " .$_SESSION["garage_amount"]. "</strong>"; 
            }
            if ($p_r == "Off Street") {
       ...
       echo'<a href="addproperty.php?session=1">View All Data</a>';
