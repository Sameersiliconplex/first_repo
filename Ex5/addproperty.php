...
if( $_GET['session'] == 1) {
                  ...
                  $zip = $_SESSION["zip"];
                   ...
                   $street_level=$_SESSION["street_level"] ;
                  ...
                  //skip dates
                   $room_furnished=$_SESSION["room_furnished"] ;
                   $date_negotiable=$_SESSION["date_negotiable"] ;
                  //Lease Type
                   $leasetype=$_SESSION["leasetype"] ;
                   $lease_type_value=$_SESSION["lease_type_value"] ;
                  ...
                  //last four field
                   ...
                   $im_looking_for=$_SESSION["im_looking_for"] ;
                   $maximum_number=$_SESSION["maximum_number"] ;
                  //*
                  ...
                  // 1)required checbox
                   ...
                   $security_amount=$_SESSION["security_amount"] ;
                   $brokerfee_amount=$_SESSION["brokerfee_amount"] ;

                  /// 2)HRES Apartment Source Pays For
                   $hres_apartment=$_SESSION["hres_apartment"] ;
              

                  //  3)rental_features
                   $rental_features=$_SESSION["rental_features2"] ;

                  //  4)community_features2
                   $other_features=$_SESSION["other_features"] ;
                  //  5)Parking_Section
                   $parking_section=$_SESSION["Parking_Section2"] ;
                   $garage_amount=$_SESSION["garage_amount"]  ;
                   $off_street_amount=$_SESSION["off_street_amount"] ;
                }
                ...
                if (isset($_POST['SubmitAdd'])) {
                    ...
                    //  3)rental_feature = $_POST['rental_features2'];
    ...
    // var_dump($_SESSION["parking_section"]);
    // die;

    // if blank box
    // "This Field is Required";
    $property_name_error = empty($property_name) ? "This Field is Required" : "";
    ...
    if (empty($property_name_error) && empty($city_error) && empty($zip_error) && empty($state_error) &&
        ...
        //  3)rental_features
        $_SESSION["rental_features2"] = $rental_features;

        //  4)community_features2
        $_SESSION["other_features"] = $other_features;
        //  5)Parking_Section
        $_SESSION["Parking_Section2"] = $parking_section;
        $_SESSION["garage_amount"] = $garage_amount ;
        $_SESSION["off_street_amount"] = $off_street_amount   ;
...
:&nbsp;</STRONG></TD>
                      <TD colSpan=4 height=30><STRONG>&nbsp;</STRONG>
                        <table cellspacing="0" cellpadding="0" width="90%"
                          ...
                          <?php
if (in_array("First Month's Rent", $required)) {echo "checked";}?>  /></td>
...
if (in_array("Last Month's Rent", $required)) {echo "checked";}?> /></td>
...
if (in_array("Security", $required)) {echo "checked";}?>/></td>
                              <td>Security</td>
                              <td>$
...
if (in_array("Broker's Fee", $required)) {echo "checked";}?>
                              /></td>
                              <td>Broker's Fee </td>
                              <td>$
...
if (in_array("References", $required)) {echo "checked";unset($_SESSION["option1"]);}?>
                              /></td>
                              <td>References</td>
                              <td>&nbsp;</td>
                            </tr>
                        ...
                        <table cellspacing="0" cellpadding="0" width="90%"
                          ...
                          <tbody>
                            <tr>
                              ...
                              value="No Utilities" name="hres_apartment[]"
                              <?php if (in_array("No Utilities", $hres_apartment)) {echo "checked";}?>
                            ...
                            name="hres_apartment[]"
                           <?php if (in_array("Heat", $hres_apartment)) {echo "checked";}?>
                            /></td>
                              <td>Heat</td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              name="0[]"
 .
                              <?php if (in_array("Hot Water", $hres_apartment)) {echo "checked";}?>
                              /></td>
                              <td>Hot Water </td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              name="hres_apartment[]"
                              <?php if (in_array("Electricity", $hres_apartment)) {echo "checked";}?>
                               /></td>
                              <td>Electricity</td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              name="hres_apartment[]"
                              <?php if (in_array("Cooking Gas", $hres_apartment)) {echo "checked";}?>
                              />
                              </td>
                              <td>Cooking Gas </td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <?php if (in_array("All Utilities", $hres_apartment)) {echo "checked";}?>
                              />
                              </td>
                              <td>All Utilities </td>
                              <td>&nbsp;</td>
                        ...
                        <tbody>
                          <tr>
                            <td valign="center"><label>
                              ...
                              <?php if (in_array("Air Conditioning",$rental_features)) {echo "checked";}?>
                              />
                            </label></td>
                            ...
                            <?php if (in_array("Carpeting",$rental_features)) {echo "checked";}?>
                             /></td>
                            <td>Carpeting</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Dishwasher"
                              name="rental_features2[]"
                              <?php if (in_array("Dishwasher",$rental_features)) {echo "checked";}?>
                          ...
                          <tr>
                            <td valign="center"><label>
                              ...
                              name="rental_features2[]
                             <?php if (in_array("Disposal",$rental_features)) {echo "checked";}?>
                              " />
                            </label></td>
                            <td>Disposal</td>
                            <td><input class="radio" id="rental_features"
                              ...
                              name="rental_features2[]"
                             <?php if (in_array("Eat-In Kitchen",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Eat-In Kitchen </td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Furnished"
                            name="rental_features2[]"
                           <?php if (in_array("Furnished",$rental_features)) {echo "checked";}?>
                            /></td>
                            <td>Furnished</td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="rental_features"
                              ...
                              name="rental_features2[]"
                             <?php if (in_array("Hardwood Floors",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Hardwood Floors</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Microwave"
                            name="rental_features2[]"
                           <?php if (in_array("Microwave",$rental_features)) {echo "checked";}?>
                            /></td>
                            <td>Microwave</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Pets Allowed"
                              name="rental_features2[]"
                             <?php if (in_array("Pets Allowed",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Pets Allowed </td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="rental_features"
                              ...
                              name="rental_features2[]"
                             <?php if (in_array("Porch Balcony",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Porch Balcony </td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Private Yard"
                              name="rental_features2[]"
                             <?php if (in_array("Private Yard",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Private Yard</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Refrigerator"
                              name="rental_features2[]"
                             <?php if (in_array("Refrigerator",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Refrigerator</td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="rental_features"
                              ...
                              name="rental_features2[]"
                             <?php if (in_array("Shared Yard/Garden",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Shared Yard/Garden </td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Separate Dining Room"
                              name="rental_features2[]"
                             <?php if (in_array("Separate Dining Room",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Separate Dining Room</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Smokers Allowed"
                              name="rental_features2[]"
                             <?php if (in_array("Smokers Allowed",$rental_features)) {echo "checked";}?>
                              /></td>
                          ...
                          <tr>
                            ...
                            name="rental_features2[]"
                            <?php if (in_array("Storage",$rental_features)) {echo "checked";}?>
                            /></td>
                            <td>Storage </td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Study/Den"
                            name="rental_features2[]"
                            <?php if (in_array("Study/Den",$rental_features)) {echo "checked";}?>
                            /></td>
                            <td>Study/Den</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="View" name="rental_features2[]"
                             <?php if (in_array("View",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>View</td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="rental_features"
                              ...
                              name="rental_features2[]"
                              <?php if (in_array("Washer/Dryer Access",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Washer/Dryer Access </td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Washer/Dryer Hookup"
                              name="rental_features2[]"
                              <?php if (in_array("Washer/Dryer Hookup",$rental_features)) {echo "checked";}?>
                              /></td>
                            <td>Washer/Dryer Hookup</td>
                            <td><input class="radio" id="rental_features"
                              type="checkbox" value="Working Fireplace"
                              name="rental_features2[]"
                              <?php if (in_array("Working Fireplace",$rental_features)) {echo "checked";}?>
                              /></td>
                        ...
                        <tbody>
                          <tr>
                            <td><input class="radio" id="community_features"
                              ...
                              name="other_features[]"
                              <?php if (in_array("Fitness Center",$other_features)) {echo "checked";}?>
                              /></td>
                            ...
                            <td><input class="radio" id="community_features"
                              ...
                              name="other_features[]"
                                     <?php if (in_array("Gated Entrance/Controlled Access",$other_features)) {echo "checked";}?>
                              /></td>
                            <td><p>Gated Entrance/Controlled Access </p></td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Garages"
                              name="other_features[]"
                                     <?php if (in_array("Garages",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>Garages </td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="community_features"
                              ...
                              name="other_features[]"
                                     <?php if (in_array("Hot Plate",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>Hot Plate</td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Kitchen Priveleges"
                              name="other_features[]"
                                     <?php if (in_array("Kitchen Priveleges",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>Kitchen Priveleges</td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Linens Supplied"
                              name="other_features[]"
                                     <?php if (in_array("Linens Supplied",$other_features)) {echo "checked";}?>
                              /></td>
                          ...
                          <tr>
                            <td><input class="radio" id="community_features"
                              ...
                              name="other_features[]"
                                     <?php if (in_array("New Building",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>New Building </td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Pool"
                            name="other_features[]"
                                   <?php if (in_array("Pool",$other_features)) {echo "checked";}?>
                            /></td>
                            <td>Pool </td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Private Entry"
                              name="other_features[]"
                                     <?php if (in_array("Private Entry",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>Private Entry</td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="community_features"
                              ...
                              name="other_features[]"
                                     <?php if (in_array("Shared Bath",$other_features)) {echo "checked";}?>
                              /></td>
                            <td>Shared Bath</td>
                            <td><input class="radio" id="community_features"
                              type="checkbox" value="Spa/Hot Tub/Sauna"
                              name="other_features[]"
                                     <?php if (in_array("Spa/Hot Tub/Sauna",$other_features)) {echo "checked";}?>
                              /></td>
                        ...
                        <tbody>
                          <tr>
                            <td valign="center" width="5%"><label>
                              ...
                              <?php if (in_array("None",$parking_section)) {echo "checked";}?>
                            ...
                            <td width="4%"><input class="radio"
                              ...
                              <?php if (in_array("On Street",$parking_section)) {echo "checked";}?>
                              /></td>
                          ...
                          <tr>
                            <td valign="center"><label>
                              ...
                              <?php if (in_array("Garage",$parking_section)) {echo "checked";}?>
                              />
                            </label></td>
...
?>
                            ...
                            name="Parking_Section2[]"
                            <?php if (in_array("Deleaded",$parking_section)) {echo "checked";}?>
                            /></td>
                            <td>Deleaded </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td><input class="radio" id="Parking_Section"
                              ...
                              name="Parking_Section2[]"
                              <?php if (in_array("Elevator Building",$parking_section)) {echo "checked";}?>
                              /></td>
                            <td colspan="2">Elevator Building </td>
                            <td><input class="radio" id="Parking_Section"
                              type="checkbox" value="Handicap Access"
                              name="Parking_Section2[]"
                              <?php if (in_array("Handicap Access",$parking_section)) {echo "checked";}?>
                              /></td>
                          ...
                          <tr>
                            <td><input class="radio" id="Parking_Section"
                              ...
                              name="Parking_Section2[]"
                              <?php if (in_array("Off Street",$parking_section)) {echo "checked";}?>
                              /></td>
                            <td>Off street</td>
                            <td>$
...
?>
                            ...
                            <td><input class="radio" id="Parking_Section"
                              ...
                              name="Parking_Section2[]"
                              <?php if (in_array("Near public transportation",$parking_section)) {echo "checked";}?>
                              /></td>
                          ...
                          <tr>
                            <td><input class="radio" id="Parking_Section"
                              ...
                              name="Parking_Section2[]"
                              <?php if (in_array("Owner Occupied",$parking_section)) {echo "checked";}?>
                              /></td>
                            ...
                            <td><input class="radio" id="Parking_Section"
                              ...
                              name="Parking_Section2[]"
                              <?php if (in_array("Walking Distance to Harvard Square",$parking_section)) {echo "checked";}?>
                              /></td>
